...
- (void)addButtonsToView: (UIView *)container
{
    ...
    for (int i=0; i<[self.buttonTitles count]; i++) {
        ...
        //54/255.0 green:120/255.0 blue:64/255.0  colorWithRed:0.0f green:0.5f blue:1.0f
        [closeButton setTitleColor:[UIColor colorWithRed:54/255.0 green:120/255.0 blue:64/255.0 alpha:1.0f] forState:UIControlStateNormal];
